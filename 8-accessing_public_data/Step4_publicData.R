...
# the goal of this script is to give you access to massive amounts of gene expression
# data without the need to download and analyze individual .fastq files this script 
# allows you to access RNAseq data from GEO and SRA using the "All RNA-seq and CHIP-Seq
# Sample and Signature Search" (ARCHS4) project (https://amp.pharm.mssm.edu/archs4)
...
archs4.mouse <- "mouse_matrix_v8.h5"
# if you placed the hdf5 file in your working directory, just use "human_matrix_v8.h5" as the path
...
ggplot(pca.pivot) +
  aes(x = sampleName, y = loadings, fill = genotype) + # you could iteratively 'paint' different covariates onto this plot using the 'fill' aes.
                                                 # Try doing this with the genotype variable you created above.
...
# visualizing PCA looking at PC2 and PC4
