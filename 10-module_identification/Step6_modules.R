...
library(gplots) #the heatmap.2 function in this package is a primary tool for making heatmaps
...
# trick to display custom colormap
z <- matrix(1:100, nrow = 1)
x <- 1
y <- seq(3, 2345, len = 100) # supposing 3 and 2345 are the range of your data
image(x, y, z, col = got_palette, axes = FALSE, xlab = "", ylab = "")
axis(2)
