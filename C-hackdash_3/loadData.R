# Introduction ----
# The goal of this short script to it make sure you are able to read the count
# data and the study design for the COVID hackdash into your R environment

# We only need a single package
library(tidyverse)
# Reading in study design incl all info for both human and ferret samples
