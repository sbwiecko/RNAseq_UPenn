...
setwd("C:/Users/WIECKOWS/Desktop/DIYtranscriptomics")
...
use_r("data")
# copy the content of pkgDocs.txt
...
use_mit_license("Sébastien Wieckowski")
...
use_git_config(user.name = "sbwiecko", user.email = "sbwiecko@free.fr")
git_sitrep()
