...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-131349832-3"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-131349832-3');
</script>
...
<body class="loading ajax-loading" data-site-url="http://diytranscriptomics.com" data-page-url="/Code/files/Rmarkdown_essentials.Rmd">
