...
author: "<center> DIYtranscriptomics class (modified by Sébastien Wieckowski <center><br>"
...
During the Spring 2020 offering of **[DIYtranscriptomics](http://diytranscriptomics.com/)**, we analyzed a subset of patients and healthy controls from [Amorim et al., 2019](https://doi.org/10.1126/scitranslmed.aax4204).  This reproducible and dynamic report was created using Rmarkdown and the [Knitr package](https://yihui.name/knitr/), and summarizes the basic code and outputs (plots, tables, etc) produced during the course.  This version was adapted for exporting to a PDF, i.e. removing interactive plots and tables.
